...
class ExecutivesController extends Controller
{
    ...
    {
        parent::init();
        $this->layout = 'executivesLayout'; // Set the layout
    }
        ...
        return [
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        'actions' => ['events','halloffame','booking','logout'],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
    ...
    /**
     * Displays kontakt page.
     *
     * @return mixed
     */
    public function actionKontakt()
    {
        $model = new KontaktForm();
     ...
     * @return mixed
     */
    public function actionVerein()
    {
        return $this->render('verein');
    }
